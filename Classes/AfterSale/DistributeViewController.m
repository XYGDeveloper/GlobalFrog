...
- (void)initView {
    ...
    commentContent = [[MyTextView alloc]initWithFrame:CGRectMake(7, 5, kScreenWidth- 20, 120) placeholderLab:@"晒一晒图吧" labFont:14.0f maxLabNum:200 alertMge:@"文字字数超出限制" addSub:self.view];
...
- (void)send {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [self.api toDistributePicWithTid:self.tid content:commentContent.text picture:pictureParameter];
    });
