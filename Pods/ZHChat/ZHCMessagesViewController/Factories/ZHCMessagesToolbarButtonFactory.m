...
#define AppStyleColor HexColor(0x5cb531) //主题绿色
...
-(UIButton *)defaultInputViewBarRightButtonItem
{
    ...
    [moreButton setTitle:@"发送" forState:UIControlStateNormal];
    [moreButton setTitleColor:AppStyleColor forState:UIControlStateNormal];
